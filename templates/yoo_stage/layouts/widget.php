...
else if (in_array($widget->position, array('headerbar', 'toolbar-r' ,'toolbar-l', 'footer-r', 'footer-l', 'offcanvas'))) {
    $panel = 'uk-panel';
}
...
// Set title
if (in_array($widget->position, array('toolbar-r' ,'toolbar-l', 'footer-r', 'footer-l'))) {
    $title = '';
...
if ($widget->menu) {
    ...
    } else if (in_array($widget->position, array('toolbar-r' ,'toolbar-l', 'footer-r', 'footer-l'))) {
        $renderer = 'subnav';
...
// Render widget
if (in_array($widget->position, array('fullscreen-a', 'fullscreen-b', 'fullscreen-c', 'fullscreen-d', 'breadcrumbs', 'logo', 'logo-small', 'search', 'dotnav', 'debug')) || (($widget->position == 'offcanvas') && $widget->menu)) {
    echo $content;
