...
foreach ($blocks as $block) {
    ...
    if ($this['config']->get("block.{$block}.block_full_width", false)) {
        $block_classes[$block] .= ' tm-block-full-width';
    }

    if ($this['config']->get("block.{$block}.block_full_height", false)) {
        $block_classes[$block] .= ' tm-block-full-height';
    }
...
$body_classes .= $this['config']->get('body_frame') ? ' tm-frame-true' : '';
$body_classes .= $this['config']->get('article_center') ? ' tm-article-center' : '';
