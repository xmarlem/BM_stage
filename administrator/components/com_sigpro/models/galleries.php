<?php
/**
 * @version		$Id: galleries.php 2770 2013-04-09 16:28:40Z lefteris.kavadas $
...
class SigProModelGalleries extends SigProModel
{
	...
	public function getData()
	{
		...
		foreach ($folders as $folder)
		{
			...
			$images = JFolder::files($folder, '.jpg|.jpeg|.png|.gif');
			...
			if (count($images) || $labels)
			{
				...
				$gallery->set('url', $url);
				$gallery->set('link', JRoute::_('index.php?option=com_sigpro&view=gallery&type='.$this->getState('type', 'site').'&folder='.$gallery->folder.'&tmpl='.JRequest::getCmd('tmpl', 'index').'&editorName='.JRequest::getCmd('editorName')));
