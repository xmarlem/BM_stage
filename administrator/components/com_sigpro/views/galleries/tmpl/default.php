<?php
/**
 * @version		$Id: default.php 2757 2013-04-08 16:41:42Z krikor $
		...
		<?php echo $this->sidebar; ?>
	   	...
	   	<div class="sigProToolbar sigTransition sigBoxSizing sigSlidingItem"> 
  	  		<div class="sigProUpperToolbar">
  	  			...
  	  			<a href="#" onclick="Joomla.submitbutton('add')" id="sigProUploader_browse" class="sigProBtnadd"><?php echo JText::_('COM_SIGPRO_ADD_NEW'); ?></a>
                ...
                <div class="sigProGalleryInner">
                   <div class="sigProImageContainer">
	                    ...
	                    <div class="sigProGalleryActions">	
	                    	<a class="sigProGalleryAction sigProInsertButton" title="<?php echo JText::_('COM_SIGPRO_INSERT'); ?>" href="<?php echo $row->folder; ?>">
