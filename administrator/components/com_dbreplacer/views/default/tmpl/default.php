						...
						<div class="row-fluid">
							...
							<div class="span4">
								<label for="dbr_regex" class="checkbox">
									<input type="checkbox" value="1" name="regex" id="dbr_regex" class="dbr_element" <?php echo JFactory::getApplication()->input->getInt('regex', 0) ? 'checked="checked"' : ''; ?>>
							...
							<div class="span4">
								<div id="<?php echo rand(1000000, 9999999); ?>___regex.1" class="nntoggler">
									<label for="dbr_utf8" class="checkbox">
										<input type="checkbox" value="1" name="utf8" id="dbr_utf8" class="dbr_element" <?php echo JFactory::getApplication()->input->getInt('utf8', 0) ? 'checked="checked"' : ''; ?>>
...
// Copyright
echo NNVersions::getInstance()->getCopyright('DB_REPLACER', '', 13004, 'dbreplacer', 'component', $this->config->show_copyright);
